...
class TriggerCollision(AtomicBehavior):
    ...
    def __init__(self, other_actor, actor, location, multiplier, adjustLocation=True, name="TriggerCollision"):
        """
        ...
        self._loopCounter = 0
        self._adjustLocation = adjustLocation
